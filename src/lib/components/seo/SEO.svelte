<script lang="ts">
	...
	// Data
	import type { IMetaTagProperties } from '$src/lib/models/interfaces/imeta-tag-properties.interface';
	// End: Local Imports
	...
	const BASE_URL: string = import.meta.env.VITE_SVELTE_BASE_URL || 'http://localhost:5173';
